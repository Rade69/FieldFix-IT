...
This project is indexed by GitNexus as **FieldFix-IT** (2134 symbols, 3933 relationships, 49 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
