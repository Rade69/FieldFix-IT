...
This project is indexed by GitNexus as **FieldFix-IT** (3040 symbols, 5422 relationships, 92 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
