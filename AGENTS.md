...
This project is indexed by GitNexus as **FieldFix-IT** (1243 symbols, 2037 relationships, 15 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
