...
This project is indexed by GitNexus as **FieldFix-IT** (2602 symbols, 4699 relationships, 69 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
